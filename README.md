...
**Image:** [`ghcr.io/adsouza98/teslacam-viewer:1.4.5`](https://github.com/Adsouza98/teslacam-viewer/pkgs/container/teslacam-viewer)
...
docker run -d --name teslacam-viewer \
  ...
  ghcr.io/adsouza98/teslacam-viewer:1.4.5
```
...
services:
  teslacam-viewer:
    image: ghcr.io/adsouza98/teslacam-viewer:1.4.5
